...
async def next_page(bot, query):
    ...
    if n_offset == 0:
        ...
        #btn.insert(0,
        #    [
         #       InlineKeyboardButton("बेजुबानों की एक अनकही दास्तां", url="https://t.me/SathAao/21"),
        #    ]
       # )
       # btn.insert(1,
       #     [
        ...
        #    ]
       # )   mujhe pata hi nahi tha ki ye kahan print hoga isiliye hata diya? doubt
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            InlineKeyboardButton('➕ Add me to your group ➕', url=f'http://t.me/{temp.U_NAME}t?startgroup=true')
            ],[
            InlineKeyboardButton(' ➡️ @SathAao 🇮🇳 ', url=f'https://t.me/SathAao')
            ],[
...
async def auto_filter(client, msg, spoll=False):
    ...
    '''btn.insert(0,
        [
            InlineKeyboardButton("how to download", url="https://t.me/how to download"),
        ]
    )
    btn.insert(1,
        [
            InlineKeyboardButton("how to download", url=f"https://t.me/how to download"),
        ]
    ) # this code will be appear above 10 list of movie name'''
