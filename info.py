...
BOT_TOKEN = environ.get('BOT_TOKEN', "7420601714:AAEa_aUYGmamBIX_Z19tWHofS5Np6GvmJY8")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002057625643 -1001429465374 -1001877117508').split()]
...
REQ_CHANNEL = environ.get("REQ_CHANNEL", '-1002229329547')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002187435610')).split()]
